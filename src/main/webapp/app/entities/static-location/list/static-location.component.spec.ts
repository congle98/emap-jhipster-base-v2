...
describe('StaticLocation Management Component', () => {
  let comp: StaticLocationComponent;
  let fixture: ComponentFixture<StaticLocationComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(StaticLocationComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(StaticLocationComponent);
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.staticLocations[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
