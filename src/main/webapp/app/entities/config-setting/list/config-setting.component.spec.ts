...
describe('ConfigSetting Management Component', () => {
  let comp: ConfigSettingComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ConfigSettingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.configSettings[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
