...
describe('TrackingList Management Component', () => {
  let comp: TrackingListComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TrackingListComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.trackingLists[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
